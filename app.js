...
//   console.log(main)
  for(var objKey of userData){
    // console.log(objKey)
    // console.log(userData)
    var objDiv = document.createElement("div");
    main.appendChild(objDiv)
    objDiv.innerText = objKey.name;
    objDiv.className = "user-cont"
    objDiv.setAttribute("onclick","handleDetail(event)")
  }

  var modalMain = document.querySelectorAll(".modal-main")[0];
